...
<?php
	if ( function_exists( 'get_option_tree') ) {
		$apex_blogsingledate = get_option_tree( 'value_blogpostdate' );
		$apex_blogsinglepostinfo = get_option_tree('value_blogpostinfo', '', false, true );
		if(!is_array($apex_blogsinglepostinfo)){ $apex_blogsinglepostinfo = array(); }
	}
    ...
    <?php while (have_posts()) : the_post(); ?>
        ...
        ?>
            ...
            <div class="eleven columns row alpha blogpost noborderbottom <?php get_post_class(); ?>" id="post-<?php the_ID(); ?>">
                ...
                <?php } ?>
                <?php if($apex_blogsingledate == "Date Box"){ ?>
